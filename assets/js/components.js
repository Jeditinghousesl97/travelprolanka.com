...
(function () {
    ...
    function getNavbarHTML() {
        const phone = getSetting('site-phone', '+94 77 440 7565');
        const email = getSetting('site-email', 'info@travelprolanka.com');
...
<nav class="navbar" id="navbar">
    <div class="container nav-container">
        ...
        <a href="${BASE}index.php" class="nav-logo">
            ${getSetting('site-logo')
                ? `<img src="${getSetting('site-logo')}" alt="${getSetting('site-name','Travel Pro Lanka (Pvt) Ltd')}" class="logo-img">`
                : `<div class="logo-icon"><i class="fa-solid fa-compass"></i></div>`
            }
            <div class="logo-text">
                <span class="logo-name">${getSetting('site-name','Travel Pro Lanka (Pvt) Ltd')}</span>
                <span class="logo-tagline">${getSetting('site-tagline','Discover Sri Lanka in Confort & Style')}</span>
            </div>
        </a>
    ...
    function getFooterHTML() {
        const phone   = getSetting('site-phone',   '+94 77 440 7565');
        const email   = getSetting('site-email',   'info@travelprolanka.com');
        const address = getSetting('site-address', 'No: 38A, Katanawatta Road, Dankotuwa, Sri Lanka');
        const waNum   = getSetting('wa-number');
...
<footer class="footer">
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                <div class="footer-logo">
                    ${getSetting('site-logo')
                        ? `<img src="${getSetting('site-logo')}" alt="${getSetting('site-name','Travel Pro Lanka (Pvt) Ltd')}" class="logo-img" style="height:38px;max-width:150px;object-fit:contain;">`
                        : `<div class="logo-icon"><i class="fa-solid fa-compass"></i></div>`
                    }
                    <span class="logo-name">${getSetting('site-name','Travel Pro Lanka (Pvt) Ltd')}</span>
                </div>
        ...
        <div class="footer-bottom">
            <p>&copy; <span id="footerYear"></span> Travel Pro Lanka (Pvt) Ltd. All rights reserved. | Designed &amp; Developed by <a href="https://www.asseminate.com/" target="_blank" rel="noopener">Asseminate</a></p>
