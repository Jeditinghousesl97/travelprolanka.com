        ...
        if (isset($_POST['send_test'])) {
            ...
            if ($testTo === '') {
                ...
                $mailResult = nt_send_mail_with_settings($s, [
                    ...
                    'subject' => 'SMTP Test Email from Travel Pro Lanka (Pvt) Ltd',
                    'html' => '<h2>SMTP Test Successful</h2><p>This test email was sent from the Travel Pro Lanka (Pvt) Ltd admin settings page.</p>',
                    'text' => "SMTP Test Successful\n\nThis test email was sent from the Travel Pro Lanka (Pvt) Ltd admin settings page.",
                ]);
      ...
      <div class="admin-card mb-3">
        ...
        <div class="p-4">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="site_name" class="form-control" value="<?= setting($s,'site_name','Travel Pro Lanka (Pvt) Ltd') ?>">
          </div>
          <div>
            <label class="form-label fw-semibold">Tagline</label>
            <input type="text" name="site_tagline" class="form-control" value="<?= setting($s,'site_tagline') ?>" placeholder="Discover Sri Lanka in Confort & Style">
          </div>
        </div>
      </div>
        ...
        <div class="p-4">
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="email" name="contact_email" class="form-control" value="<?= setting($s,'contact_email') ?>" placeholder="info@travelprolanka.com"></div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="p-4">
          <div class="theme-preview">
            <div class="theme-preview__hero">
              ...
              <h4><?= htmlspecialchars($s['site_name'] ?? 'Travel Pro Lanka (Pvt) Ltd') ?></h4>
        ...
        <div class="p-4">
          <div class="mb-3">
            ...
            <input type="text" name="seo_meta_title" id="metaTitleInput" class="form-control" maxlength="70"
                   value="<?= setting($s,'seo_meta_title') ?>" placeholder="Travel Pro Lanka (Pvt) Ltd, Sri Lanka Tour Packages">
      ...
      <div class="admin-card mb-3">
        ...
        <div class="p-4">
          <div class="google-preview">
            <div class="gp-url">travelprolanka.com</div>
          ...
          <div class="row g-3">
            <div class="col-sm-8">
              ...
              <input type="text" name="smtp_host" class="form-control"
                     ...
                     placeholder="mail.travelprolanka.com  or  smtp.gmail.com">
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" name="smtp_username" class="form-control"
                     ...
                     placeholder="info@travelprolanka.com">
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-4">
              ...
              <input type="text" name="smtp_from_name" class="form-control"
                     value="<?= setting($s,'smtp_from_name','Travel Pro Lanka (Pvt) Ltd') ?>">
            </div>
            <div class="col-sm-4">
              <label class="form-label fw-semibold">From Email</label>
              <input type="email" name="smtp_from_email" class="form-control"
                     value="<?= setting($s,'smtp_from_email') ?>"
                     placeholder="no-reply@travelprolanka.com">
            </div>
            <div class="col-12">
              ...
              <input type="email" name="smtp_notify_email" class="form-control"
                     ...
                     placeholder="owner@travelprolanka.com">
            </div>
          </div>
        </div>
      </div>
