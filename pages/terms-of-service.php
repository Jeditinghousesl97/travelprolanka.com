...
$seoTitle = 'Terms of Service | Travel Pro Lanka (Pvt) Ltd';
$seoDesc = 'Terms of Service for Travel Pro Lanka (Pvt) Ltd. Read our booking terms, cancellation policy, and conditions of travel.';
...
<body>
    ...
    <div class="policy-body">
        ...
        <p>These Terms of Service govern your use of the Travel Pro Lanka (Pvt) Ltd website and the booking of our travel services. By accessing our website or making a booking, you agree to be bound by these terms. Please read them carefully before proceeding.</p>

        <h2>1. About Us</h2>
        <p>Travel Pro Lanka (Pvt) Ltd is a licensed travel company based in Sri Lanka, specialising in tailor-made tours, holiday packages, and travel services across the island. Our registered office is at <?= htmlspecialchars($cfg('contact_address', 'No: 38A, Katanawatta Road, Dankotuwa, Sri Lanka')) ?>.</p>
        ...
        <p>We strongly recommend that all travellers obtain comprehensive travel insurance prior to departure, covering cancellation, medical emergencies, personal accident, and loss of baggage. Travel Pro Lanka (Pvt) Ltd is not liable for any costs arising from events covered by travel insurance.</p>
